...
@section('sub-content')
    <div class="container">
        <div class="row justify-content-center">
           ...
           <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ __('View Student') }}</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="d-flex justify-content-around">
                                    ...
                                    <div class="p-2 flex-fill border border-warning rounded">
                                        <h6 class="fw-bold">Is RTE Student</h6>
                                        {{ isset($student) && $student->is_rtest == 1 ? 'Yes' : 'No' }}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
