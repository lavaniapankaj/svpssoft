...
@section('sub-content')
    <div class="container-fluid">
        ...
        <div class="row">
           ...
           <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ 'Edit Student'}}</h5>
                                ...
                                <div class="form-step" id="step1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="age_proof" id="age_proof" class="form-control @error('age_proof') is-invalid @enderror" required>
                                ...
                                <div class="form-step" id="step2" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" name="std_email" id="std_email" placeholder="Enter email" class="form-control @error('std_email') is-invalid @enderror" value="{{ old('std_email', isset($student_detail) ? $student_detail->email : '') }}">
                                            @error('std_email')
                                                <span class="invalid-feedback form-invalid fw-bold"
                                                    role="alert">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-step" id="step3" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="g_father" id="g_father" placeholder="Enter Grandfather's Name" class="form-control @error('g_father') is-invalid @enderror" value="{{ old('g_father', isset($parent_detail) ? $parent_detail->g_father : '') }}">
                                            @error('g_father')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="m_name" id="m_name" placeholder="Enter Mother's Name" class="form-control @error('m_name') is-invalid @enderror" value="{{ old('m_name', isset($parent_detail) ? $parent_detail->m_name : '') }}" required>
                                            @error('m_name')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" name="parent_email" id="parent_email" placeholder="Enter Email" class="form-control @error('parent_email') is-invalid @enderror" value="{{ old('parent_email', isset($parent_detail) ? $parent_detail->email : '') }}">
                                            @error('parent_email')
                                                <span class="invalid-feedback form-invalid fw-bold"
                                                    role="alert">{{ $message }}</span>
                                            @enderror
