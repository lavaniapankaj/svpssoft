            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card border-0 bg-white">
                        <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ 'Add New Student' }}</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="isrte" id="isrte" class="form-control @error('isrte') is-invalid @enderror" required>
                                                <option value="1" {{ old('isrte') == 1 ? 'selected' : '' }}>
                                                    Yes
                                                </option>
                                                <option value="0" {{ old('isrte') == 0 ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                            @error('isrte')
                                ...
                                <div class="form-step" id="step2" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" name="std_email" id="std_email" placeholder="Enter Email" class="form-control @error('std_email') is-invalid @enderror" value="{{ old('std_email') }}">
                                            @error('std_email')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-step" id="step3" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="g_father" id="g_father" placeholder="Enter Grandfather's Name" class="form-control @error('g_father') is-invalid @enderror" value="{{ old('g_father') }}">
                                            @error('g_father')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" name="parent_email" placeholder="Enter Email" id="parent_email" class="form-control @error('parent_email') is-invalid @enderror" value="{{ old('parent_email') }}">
                                            @error('parent_email')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
