            ...
            function marksheetData() {
                ...
                $.ajax({
                    ...
                    data: {
                        class: classId,
                        section: sectionId,
                        // students: studentIds[currentIndex],
                        students: stdId,
                        exam: examId,
                        ...
                        if (response.data) {
                            ...
                            response.data.forEach(function(studentData, index) {
                                ...
                                examsData.forEach(exam => {
                                    ...
                                    if (exam.by_m_g == 1 && exam.priority ==
                                        1 && exam['exam-info'] && exam[
                                            'exam-info'].length > 0) {

                                        tableHtml +=
                                            `<tr><td style="white-space:nowrap;">${exam.subject}</td>`;
                                        ...
                                        if (withoutId != '') {
                                            tableHtml +=
                                                `<td class="text-center">${subjectTotal}</td></tr>`;
                                        }
                                    }

                                });
                                tableHtml +=
                                    `<tr> <td class="text-end fw-bold">Total</td>`;
                                ...
                                examsData.forEach(exam => {
                                    ...
                                    if (exam['exam-info'] && exam['exam-info']
                                        ...
                                        exam['exam-info'].forEach(info => {
                                            ...
                                            if (!examGroupedById2[info
                                                    .exam_id]) {

                                                examGroupedById2[info
                                                    .exam_id] = {
                                ...
                                tableHtml +=
                                    `<th class="text-center align-middle" rowspan="2">Grand Total</th></tr>`;
                                tableHtml += `<tr style="height:40px;">`;
                                ...
                                if (examsData[0].by_m_g == 1 && examsData[0].priority ==
                                    ...
                                    Object.keys(examGroupedById).forEach(examId => {
                                        ...
                                        let examGroup = examGroupedById[
                                            examId
                                        ]; // Get the exam group by exam_id



                                        // Check if the exam is in the 'withoutId' array

                                        if (withId && (withId.includes(examGroup
                                                .examID.toString()))) {
                                ...
                                examsData.forEach(exam => {
                                    ...
                                    if (exam.by_m_g == 1 && exam.priority ==
                                        1 && exam['exam-info'] && Array.isArray(
                                            exam['exam-info']) && exam[
                                            'exam-info'].length > 0) {
                                ...
                                if (allSubjectsSameExam) {
                                    ...
                                    examsData.forEach(exam => {
                                        ...
                                        if (exam.by_m_g == 2 && exam[
                                            ...
                                            Object.keys(examGroupedGradeById)
                                                .forEach(examId => {
