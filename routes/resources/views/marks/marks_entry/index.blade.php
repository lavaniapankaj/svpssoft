        ...
        <div class="col-md-12">
            <div class="card border-0 bg-white">
                <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('marks.marks-entry.index') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#class_id, #section_id').on('change', function() {
            ...
            // Clear student table
            $('#std-container table tbody').html('');
        });
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.studentsCount !== undefined && response.studentsCount == 0) {
                            ...
                            if (response.exists) {
                                $('#marksExistsMsg').text(response.msg);
                            } else {
                                $('#marksExistsMsg').text('');
                                getStudentsForMarks();
                            }
                    ...
                    success: function(response) {
                        if (response.success == true) {
                            Swal.fire({
                                ...
                                // location.reload();
                                /* Rather then reload, we can update the UI dynamically */
                                //  Reset studentMarks memory
                                studentMarks = {};

                                //  Hide student form and clear table
                                $('#std-form').hide();
                                $('#std-container table tbody').html('');
                            });
                        }
