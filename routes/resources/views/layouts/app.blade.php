...
<body class="{{ Auth::check() ? 'loggedIn' : 'guest' }}">
    <div id="app">
        <div class="header">
            <div class="container max_contaier">
                <div class="row justify-content-between">
                    <div class="col-lg-2">
                        <div class="logo_item">
                        <i class="bx bx-menu" id="sidebarOpen"></i>
                        <a class="navbar-brand" href="{{ url('/') }}" style="color:white !important ;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    ...
                    <div class="col-lg-5">
                        <div class="menu_data d-flex justify-content-end gap-3 align-items-center">
                             @guest
                            @else
                            <div class="text-white d-flex align-items-center gap-1">
                                <p class="my-0 pys-0 fw-bold">Current Session</p>
                                @yield('current-session')
                            </div>
                          <div class="nav-item dropdown top_barmenu">
                                <a class="nav-link dropdown-toggle text-white nameuser d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">{{ Auth::user()->name }} <span class="mdi mdi-account-circle"></span></a>
                                <ul class="dropdown-menu">

                                    {{-- <li>
                                        <a class="dropdown-item " href="{{ route('admin.changePass') }}">
                                            <span class="droppopup">
