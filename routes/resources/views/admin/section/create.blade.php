    ...
    <div class="container-fluid">
        ...
        <div class="row ">
           ...
           <div class="card-header bg-white d-flex align-items-center justify-content-between">
            <h5 class="mb-0 mt-0">{{ 'Add New Section' }}</h5>
                        <a href="{{ route('admin.section-master.index') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
