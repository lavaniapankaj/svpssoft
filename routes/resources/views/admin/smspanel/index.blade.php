...
@section('sub-content')
    <div class="container-fluid">
        ...
        <div class="row">
           ...
           <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ 'SMS Panel' }}</h5>
                        <a href="{{ route('admin.sms-panel.index') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
