        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 bg-white">
                    <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ __('Fee Report') }}</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#export-button').on('click', function() {
                ...
                let startDateId = $('#start-date').val();
                let endDateId = $('#end-date').val();
                const exportUrl = "{{ route('admin.reports.adminFullFee.excel') }}?session=" +
                    sessionId +
