...
@section('sub-content')
    <div class="container-fluid">
        ...
        <div class="row">
           ...
           <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ __('Student Report (Transport/ without Transport)') }}</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#export-button1').on('click', function() {
                ...
                const exportUrl = "{{ route('admin.reports.exportReportByTransportWise') }}?session_id=" +
                    session +
