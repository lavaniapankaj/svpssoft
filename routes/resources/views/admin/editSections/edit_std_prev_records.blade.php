...
@section('sub-content')
    <div class="container-fluid">
        ...
        <div class="row">
           ...
           <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ 'Edit Current/Previous Records' }}</h5>
                        ...
                        <div class="mt-4" id="std-form">
                            <form action="{{ route('admin.editSection.editStdByPreSrno.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="f_name" class="mt-2">Father's Name <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="m_name" class="mt-2">Mother's Name <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="category" class="mt-2">Category<span class="text-danger">*</span></label>
