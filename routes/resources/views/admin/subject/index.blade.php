            ...
            <div class="col-md-12">
                <div class="card border-0 bg-white">
                   <div class="card-header bg-white d-flex align-items-center justify-content-between">
                        <h5 class="mb-0 mt-0">{{ __('Subject Master') }}</h5>
                        
                        <div class=" flex-column d-flex align-items-end ">
                            <a href="{{ route('admin.subject-master.create') }}" class="btn btn-success text-white"><span class="mdi mdi-plus-circle-outline me-2"></span>Add</a>
                            <div class="d-flex align-items-center gap-1 mt-2">
                                <form action="{{ route('admin.subject-master.index') }}" method="get" class="d-flex">
                                ...
                                <a href="{{ route('admin.subject-master.index') }}" class="btn btn-dark">Reset</a>
                            </div>
                        </div>
