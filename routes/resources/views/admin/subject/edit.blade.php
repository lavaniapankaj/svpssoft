    ...
    <div class="container-fluid">
        <div class="row">
           ...
           <div class="card-header bg-white d-flex align-items-center justify-content-between">
            <h5 class="mb-0 mt-0">{{ 'Edit Subject' }}</h5>
                            <a href="{{ route('admin.subject-master.index') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
                        </div>

                        <div class="card-body">
                            <form action="{{ route('admin.subject-master.update', $subjectMaster->id) }}" method="POST" id="basic-form">
                                @csrf
                                @method('put')
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="hidden" id="initialClassId"
                                            value="{{ isset($subjectMaster) ? $subjectMaster->class_id : '' }}">
                                    ...
                                    <div class="form-group form-check col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('by_m_g') is-invalid @enderror"
                                                ...
                                                {{ isset($subjectMaster) && $subjectMaster->by_m_g == 1 ? 'checked=' . '"' . 'checked' . '"' : '' }}>
                                    ...
                                    <div class="form-group form-check col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input @error('by_m_g') is-invalid @enderror"
                                                ...
                                                {{ isset($subjectMaster) && $subjectMaster->by_m_g == 2 ? 'checked=' . '"' . 'checked' . '"' : '' }}>
