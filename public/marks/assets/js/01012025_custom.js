                    ...
                    $.each(response.data.student, function (key, value) {
                        ...
                        <table class="table">
                            ...
                            <thead>
                                ...
                                <tr class="">
                                    ...
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0 align-content-start px-4"><img src="${value.logo}" alt=""></th>

                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0" width="8%">

                                    </th>
                                    <th colspan="3" class="border-start-0 border-end-0 border-bottom-0 fs-3 text-break px-0 pb-0">
                                        <p class="text-center mb-0">${value.school} </p>
                                        <p class="fs-5 text-center mb-0">(English Medium) </p>
                                        <p class="fs-5 text-center mb-0">Vivekanand Chowk, Chirawa</p>
                                    </th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0"></th>
                                </tr>
                                ...
                                <tr class="">
                                    ...
                                    <th colspan="6" class="text-center fs-5 border-bottom-0 p-0"><p>Session: ${value.session || ''}</p></th>
                                ...
                                <tr class="">
                                    ...
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.name || ''}</th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0"></th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">SRNO: </th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.srno || ''}</th>

                                </tr>
                                <tr class="">
                                    <th colspan="2" class="border-start-0 border-end-0 border-bottom-0">Father's Name: </th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.father_name || ''}</th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0"></th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">DOB: </th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.dob || ''}</th>
                                ...
                                <tr class="">
                                    ...
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.class_name || ''}</th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0"></th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">Section: </th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.section_name || ''}</th>
                                ...
                                <tr class="">
                                    ...
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.rollno || ''}</th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0"></th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">Exam: </th>
                                    <th colspan="1" class="border-start-0 border-end-0 border-bottom-0">${value.exam_name || ''}</th>
                        ...
                        if (upperHeader == true) {
                            ...
                            tableHtml += `    <tr class="">
                                        ...
                                        <th colspan="1" class="border-end-0 border-bottom-0"></th>
                                        <th colspan="1" class="border-end-0 border-bottom-0">Subject</th>

                                        <th colspan="1" class="border-end-0 border-bottom-0">Written</th>

                                        <th colspan="1" class="border-end-0 border-bottom-0">Oral</th>

                                        <th colspan="1" class="border-end-0 border-bottom-0">Practical</th>

                                        <th colspan="1" class="border-end-0 border-bottom-0">Total</th>
                                ...
                                if (subject.by_m_g == 1) {
                                    ...
                                    tableHtml += `
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td colspan="1"  class="border-start-0 border-end-0 border-bottom-0"></td>
                                                    <td colspan="1"  class="border-start-0 border-end-0 border-bottom-0">${subject.name || '--'}</td>

                                                    <td colspan="1" class="border-start-0 border-end-0 border-bottom-0">${subject.written || '--'}</td>

                                                    <td colspan="1" class="border-start-0 border-end-0 border-bottom-0">${subject.oral || '--'}</td>

                                                    <td colspan="1" class="border-start-0 border-end-0 border-bottom-0">${subject.practical || '--'}</td>
                        ...
                        if (upperHeader == true) {
                            tableHtml += `
                                        ...
                                        <tr class="">
                                            ...
                                            <th colspan="1" class="border-start-1 border-top border-bottom-1"></th>
                                            <th colspan="1" class="border-start-1 border-top border-bottom-1">Grand Total</th>
                                            <th colspan="1" class="border-start-1 border-top border-bottom-1"></th>
                                            <th colspan="1" class="border-start-1 border-top border-bottom-1"></th>
                                            <th colspan="1" class="border-start-1 border-top border-bottom-1"></th>

                                            <td colspan="1" class="border-start-1 border-top border-bottom-1">${value.grand_total_marks || ''}</td>
            ...
            success: function (response) {
                ...
                if (Array.isArray(response.data) && response.data.length > 0) {
                    ...
                    response.data.forEach(function (studentData, index) {
                        ...
                        tableHtml += `<div class="col-${colValue2} px-0"><table class="table table-bordered h-100 w-100 add mb-0"><thead>`;
                            ...
                            Object.keys(examGroupedById).forEach(examId => {
                                ...
                                if (withId && (withId.includes(examGroup.examID.toString()))) {
                                    ...
                                    if (examInfo) {
                                        ...
                                        tableHtml += `<td class="text-center">${examInfo.written_max_marks}</td>
                                ...
                                Object.keys(examGroupedById2).forEach(examId => {
                                    ...
                                    if (examInfo) {
                                        ...
                                        if (withId && (withId.includes(examGroup.examID.toString()))) {
                                            ...
                                            tableHtml += `<td class="text-center">${examInfo.written_marks}</td>
                        ...
                        Object.keys(examGroupedById2).forEach(examId => {
                            ...
                            if (withId && (withId.includes(exam.examID.toString()))) {
                                ...
                                tableHtml += `<td></td><td></td><td class="text-center">${exam.totalMarks}</td>`;
                        ...
                        tableHtml += `<th>Total</th></tr></thead><tbody><tr><td>Total Meetings</td>`;
                        ...
                        tableHtml += `<td>${attendanceData.summary.total_meetings}</td></tr><tr><td>Attended</td>`;
