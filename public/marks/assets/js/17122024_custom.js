                        ...
                        <table class="table">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="border-start-0 border-end-0 border-bottom-0 align-content-start"><img src="${value.logo}" alt=""></th>

                                    <th colspan="4" class="border-start-0 border-end-0 border-bottom-0 fs-3 text-break"><p class="text-center">${value.school} </p><p class="fs-5 text-center">(English Medium) </p><p class="fs-5 text-center">Vivekanand Chowk, Chirawa</p></th>
                            ...
                            tableHtml += `<tr>
                                        ...
                                        <th class="border-start-0 border-end-0 border-bottom-0"><img src="${siteUrl + '/public/marks/images/' + value.principle_sign}" alt="" style="height:35px;"></th>
            ...
            if (Array.isArray(response.data) && response.data.length > 0) {
                ...
                response.data.forEach(function (studentData, index) {
                    ...
                    tableHtml += `
                                          ...
                                          <tr><th class="px-0"><div class="border px-0">Attendance Record</div></th></tr>
