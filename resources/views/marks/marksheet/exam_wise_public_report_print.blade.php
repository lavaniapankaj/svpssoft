...
@section('sub-content')
    <div class="container-fluid">
        <div class="row">
           ...
           <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ 'Print Report Exam Wise' }}</h5>
             <div class="align-items-center d-flex gap-2">
                        <a href="{{ route('marks.marks-report.public-exam-wise') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
                        <button type="button" id="print-marksheet" class="btn btn-sm btn-primary print-marksheet mx-2" >Print Marksheet</button>
                    </div>
                    </div>
                    <div class="card-body">
