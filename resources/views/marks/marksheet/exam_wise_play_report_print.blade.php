            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ 'Print Report Exam Wise (Play House)' }}
                        <a href="{{ route('marks.marks-report.play-exam-wise') }}" class="btn btn-warning btn-sm" style="float: right;">Back</a>
                        <button type="button" id="print-marksheet" class="btn btn-primary btn-sm print-marksheet mx-2" style="float: right;">Print Marksheet</button>
                    </div>
                    <div class="card-body">
