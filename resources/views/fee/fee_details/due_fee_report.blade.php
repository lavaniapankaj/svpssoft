...
@section('sub-content')
    <div class="container-fluid">
        ...
        <div class="row">
           ...
           <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between"><h5 class="mb-0 mt-0">{{ 'Due Fee Report' }}</h5>
                        <a href="{{ route('fee.due-fee-report') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#export-button').click(function() {
                ...
                let exportUrl = "{{ route('fee.std-due-fee-report-excel') }}" +
                ...
                $.ajax({
                    url: "{{ route('fee.check-due-fee-data') }}",
                    type: 'GET',
                    data: {
                        class: selectedClassVal,
                        section: selectedSectionVal,
