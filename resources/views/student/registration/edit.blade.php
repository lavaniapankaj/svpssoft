                                ...
                                <div class="form-step" id="step1">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <input type="hidden" name="session" value='{{ old('session', isset($student) ? $student->session_id : '') }}'
                                                id="session">
                                ...
                                <div class="form-step" id="step2" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="hidden" name="initialStateId" id="initialStateId"
                                                value="{{ old('state_id', isset($student_detail) ? $student_detail->state_id : '') }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="f_name" id="f_name"
                                                ...
                                                value="{{ old('f_name', isset($parent_detail) ? $parent_detail->f_name : '') }}"
                                                required>
                                            @error('f_name')
                                                <span class="invalid-feedback form-invalid fw-bold"
                                                    role="alert">{{ $message }}</span>
