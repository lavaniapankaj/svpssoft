                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="school" id="school"
                                                ...
                                                <option value="1"
                                                    {{ old('school') == 1 ? 'selected' : '' }}>
                                                    Play House</option>
                                                <option value="2"
                                                    {{ old('school') == 2 ? 'selected' : '' }}>
                                                    Public</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="transport" id="transport"
                                                ...
                                                <option value="1"
                                                    {{ old('transport') === 1 ? 'selected' : '' }}>
                                                    Yes</option>
                                                <option value="0"
                                                    {{ old('transport') === 0 ? 'selected' : '' }}>
                                                    No</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="age_proof" id="age_proof"
                                                ...
                                                <option value="1"
                                                    {{ old('age_proof') == 1 ? 'selected' : '' }}>
                                                    Transfer Certificate (T.C.)</option>
                                                <option value="2"
                                                    {{ old('age_proof') == 2 ? 'selected' : '' }}>
                                                    Birth Certificate</option>
                                                <option value="3"
                                                    {{ old('age_proof') == 3 ? 'selected' : '' }}>
                                                    Affidavit</option>
                                                <option value="4"
                                                    {{ old('age_proof') == 4 ? 'selected' : '' }}>
                                                    Aadhar Card</option>
                                            </select>
                                            @error('age_proof')
                                                <span class="invalid-feedback form-invalid fw-bold"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="religion" id="religion"
                                                ...
                                                <option value="1"
                                                    {{ old('religion') == 1 ? 'selected' : '' }}>
                                                    Hindu</option>
                                                <option value="2"
                                                    {{ old('religion') == 2 ? 'selected' : '' }}>
                                                    Muslim</option>
                                                <option value="3"
                                                    {{ old('religion') == 3 ? 'selected' : '' }}>
                                                    Christian</option>
                                                <option value="4"
                                                    {{ old('religion') == 4 ? 'selected' : '' }}>
                                                    Sikh</option>
                                            </select>
                                            @error('religion')
                                                <span class="invalid-feedback form-invalid fw-bold"
                                ...
                                <div class="form-step" id="step3" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="parent_category_id" id="parent_category_id"
                                                ...
                                                <option value="">Select Category</option>
                                                <option value="1"
                                                    {{ old('parent_category_id') == 1 ? 'selected' : '' }}>
                                                    General</option>
                                                <option value="2"
                                                    {{ old('parent_category_id') == 2 ? 'selected' : '' }}>
                                                    OBC</option>
                                                <option value="3"
                                                    {{ old('parent_category_id') == 3 ? 'selected' : '' }}>
                                                    SC</option>
                                                <option value="4"
                                                    {{ old('parent_category_id') == 4 ? 'selected' : '' }}>
                                                    ST</option>
                                                <option value="5"
                                                    {{ old('parent_category_id') == 5 ? 'selected' : '' }}>
                                                    BC</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="f_occupation" id="f_occupation"
                                                ...
                                                <option value="1"
                                                    {{ old('f_occupation') == 1 ? 'selected' : '' }}>
                                                    Private Service</option>
                                                <option value="2"
                                                    {{ old('f_occupation') == 2 ? 'selected' : '' }}>
                                                    Govt. Service</option>
                                                <option value="3"
                                                    {{ old('f_occupation') == 3 ? 'selected' : '' }}>
                                                    Farmer</option>
                                                <option value="4"
                                                    {{ old('f_occupation') == 4 ? 'selected' : '' }}>
                                                    Business</option>
                                                <option value="5"
                                                    {{ old('f_occupation') == 5 ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="m_occupation" id="m_occupation"
                                                ...
                                                <option value="1"
                                                    {{ old('m_occupation') == 1 ? 'selected' : '' }}>
                                                    Private Service</option>
                                                <option value="2"
                                                    {{ old('m_occupation') == 2 ? 'selected' : '' }}>
                                                    Govt. Service</option>
                                                <option value="3"
                                                    {{ old('m_occupation') == 3 ? 'selected' : '' }}>
                                                    House Wife</option>
                                                <option value="4"
                                                    {{ old('m_occupation') == 4 ? 'selected' : '' }}>
                                                    Business</option>
                                                <option value="5"
                                                    {{ old('m_occupation') == 5 ? 'selected' : '' }}>
                                                    Military Service</option>
                                            </select>
                                            @error('m_occupation')
                                                <span class="invalid-feedback form-invalid fw-bold"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="hidden" name="initialParentStateId" id="initialParentStateId"
                                                value="{{ old('parent_state_id') }}">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="hidden" name="initialParentDistrictId"
                                                id="initialParentDistrictId"
                                                value="{{ old('parent_district_id') }}">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="parent_address" id="parent_address"
                                                class="form-control @error('parent_address') is-invalid @enderror" rows="3" required>{{ old('parent_address') }}</textarea>
