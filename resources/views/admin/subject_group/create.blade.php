    ...
    <div class="container-fluid">
        ...
        <div class="row">
           ...
           <div class="card-header bg-white d-flex align-items-center justify-content-between">
            <h5 class="mb-0 mt-0">{{ 'Create New Subject Group' }}</h5>
                            <a href="{{ route('admin.subject-group-master.index') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
                        </div>
