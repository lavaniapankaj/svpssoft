...
@section('sub-content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Subject Master') }}
                        <a href="{{ route('admin.subject-master.create') }}" class="btn btn-info" style="float: right;">Add</a>
                        <div class="col-lg-12 col-md-12">
                            <div class="right-item d-flex justify-content-end mt-4">
                                ...
                                <a href="{{ route('admin.subject-master.index') }}" class="btn btn-warning">Reset</a>
                            </div>
                        </div>
