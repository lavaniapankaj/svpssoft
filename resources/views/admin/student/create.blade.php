            ...
            <div class="col-md-12">
                ...
                <div class="card border-0 bg-white">
                        <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between">
                            <h5 class="mb-0 mt-0">{{ isset($student) && isset($student->id) ? 'Edit Student' : 'Add New Student' }}</h5>
                            <a  id="btn-back" onclick="history.back()" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="form-step" id="step1">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="srno" id="srno" class="form-control @error('srno') is-invalid @enderror" value="{{ old('srno', isset($student) ? $student->srno : '') }}" required>
                                            @error('srno')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="rollno" id="rollno" class="form-control @error('rollno') is-invalid @enderror" value="{{ old('rollno', isset($student) ? $student->rollno : '') }}">
                                            @error('rollno')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="isrte">Is RTE Student <span class="text-danger">*</span></label>
                                            <select name="isrte" id="isrte" class="form-control @error('isrte') is-invalid @enderror" required>
                                                <option value="1" {{ old('isrte', isset($student) ? $student->is_rtest : '') == 1 ? 'selected' : '' }}>
                                                    Yes
                                                </option>
                                                <option value="0" {{ old('isrte', isset($student) ? $student->is_rtest : '') == 0 ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                            @error('isrte')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" name="admission_date" id="admission_date" class="form-control @error('admission_date') is-invalid @enderror" value="{{ old('admission_date', isset($student) ? $student->admission_date : '') }}">
                                    ...
                                    <div class="row" id="transportFeeDiv">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="trans_1st_inst" id="trans_1st_inst" class="form-control @error('trans_1st_inst') is-invalid @enderror" value="{{ old('trans_1st_inst', isset($student) ? $student->trans_1st_inst : '') }}" required>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="trans_2nd_inst" id="trans_2nd_inst" class="form-control @error('trans_2nd_inst') is-invalid @enderror" value="{{ old('trans_2nd_inst', isset($student) ? $student->trans_2nd_inst : '') }}" required>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="trans_discount" id="trans_discount" class="form-control @error('trans_discount') is-invalid @enderror" value="{{ old('trans_discount', isset($student) ? $student->trans_discount : '') }}" required>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="trans_total" id="trans_total" class="form-control @error('trans_total') is-invalid @enderror" value="{{ old('trans_total', isset($student) ? $student->trans_total : '') }}" readonly>
                                            @error('trans_total')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-step" id="step2" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" required value="{{ old('name', isset($student_detail) ? $student_detail->name : '') }}" required>
                                            @error('name')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" name="dob" id="dob" class="form-control @error('dob') is-invalid @enderror" value="{{ old('dob', isset($student_detail) ? $student_detail->dob : '') }}">
                                            @error('dob')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" name="std_email" id="std_email" class="form-control @error('std_email') is-invalid @enderror" value="{{ old('std_email', isset($student_detail) ? $student_detail->email : '') }}">
                                            @error('std_email')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="tel" name="mobile" id="mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile', isset($student_detail) ? $student_detail->mobile : '') }}" required>
                                            @error('mobile')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    @if (isset($student) && $student->session_id !== Session::get('current_session')->id)
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="pre_school" id="pre_school" class="form-control @error('pre_school') is-invalid @enderror" value="{{ old('pre_school', isset($student_detail) ? $student_detail->pre_school : '') }}">
                                                @error('pre_school')
                                                    <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="pre_class" id="pre_class" class="form-control @error('pre_class') is-invalid @enderror" value="{{ old('pre_class', isset($student_detail) ? $student_detail->pre_class : '') }}">
                                                @error('pre_class')
                                                    <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="reason" id="reason" class="form-control @error('reason') is-invalid @enderror" value="{{ old('reason', isset($student) ? $student->reason : '') }}">
                                                @error('reason')
                                                    <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="TCRefNo" id="TCRefNo" class="form-control @error('TCRefNo') is-invalid @enderror" value="{{ old('TCRefNo', isset($student) ? $student->TCRefNo : '') }}">
                                                @error('TCRefNo')
                                                    <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="pincode" id="pincode" class="form-control @error('pincode') is-invalid @enderror" value="{{ old('pincode', isset($student_detail) ? $student_detail->pincode : '') }}" required>
                                            @error('pincode')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="3" required>{{ old('address', isset($student_detail) ? $student_detail->address : '') }}</textarea>
                                            @error('address')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="relative-div">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="right-item d-flex justify-content-end mt-5">
                                                    <input type="text" name="search" id="search" class="form-control mx-2" placeholder="Search by Name" value="{{ old('search', request()->get('search') !== null ? request()->get('search') : '') }}">
                                                    <button type="button" class="btn btn-sm btn-info" id="searchButton">Search</button>
                                                </div>
                                            </div>
                                        </div>
                                        <img src="{{ config('myconfig.myloader') }}" alt="Loading..." class="loader" id="loader" style="display:none; width:5%;">
                                        <div class="row" id="studentResults" style="display:none;">
                                            <div class="form-group col-md-10 mt-3">
                                                ...
                                                <select name="relativeStd" id="relativeStd" class="form-control relativeStd @error('relativeStd') is-invalid @enderror">
                                                    <option value="">Select Student</option>
                                                </select>
                                            </div>
                                            <div class="form-group align-content-end col-md-2 px-2">
                                                <div>
                                                    <button type="button" id="relative-std-btn" class="btn btn-sm btn-primary">Add to Relatives</button>
                                                </div>
                                            </div>
                                ...
                                <div class="form-step" id="step3" style="display: none;">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="f_name" id="f_name" class="form-control @error('f_name') is-invalid @enderror" value="{{ old('f_name', $parent_detail->f_name ?? '') }}" required>
                                            @error('f_name')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="g_father" id="g_father" class="form-control @error('g_father') is-invalid @enderror" value="{{ old('g_father', isset($parent_detail) ? $parent_detail->g_father : '') }}">
                                            @error('g_father')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="tel" name="f_mobile" id="f_mobile" class="form-control @error('f_mobile') is-invalid @enderror" value="{{ old('f_mobile', isset($parent_detail) ? $parent_detail->f_mobile : '') }}">
                                            @error('f_mobile')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="m_name" id="m_name" class="form-control @error('m_name') is-invalid @enderror" value="{{ old('m_name', isset($parent_detail) ? $parent_detail->m_name : '') }}" required>
                                            @error('m_name')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="tel" name="m_mobile" id="m_mobile" class="form-control @error('m_mobile') is-invalid @enderror" value="{{ old('m_mobile', isset($parent_detail) ? $parent_detail->m_mobile : '') }}">
                                            @error('m_mobile')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="email" name="parent_email" id="parent_email" class="form-control @error('parent_email') is-invalid @enderror" value="{{ old('parent_email', isset($parent_detail) ? $parent_detail->email : '') }}" >
                                            @error('parent_email')
                                                <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                            @enderror
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const showStep = (step) => {
                ...
                $('#nextBtn').text(step === totalSteps ? (id.val().trim() !== '' ? 'Update' : 'Submit') : 'Next');
            };
            ...
            const validateField = ($field) => {
                ...
                } else if ($field.attr('type') === 'email' && $field.val() && !validateEmail($field.val())) {
                    isValid = false;
