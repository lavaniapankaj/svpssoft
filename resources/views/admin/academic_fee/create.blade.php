        ...
        <div class="col-md-12">
            <div class="card border-0 bg-white">
                <div class="card-header flex-wrap bg-white d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 mt-0">{{ 'Add New Academic Fee' }}</h5>
                    <a href="{{ route('admin.academic-fee-master.index') }}" class="btn bg-light btn-sm" ><span class="mdi mdi-chevron-left me-2"></span>Back</a>
                </div>
                <div class="card-body">
                        <form action="{{ route('admin.academic-fee-master.store') }}" method="POST" id="basic-form">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mt-2">
                                    ...
                                    <input type="text" name="admission_fee" id="admission_fee" class="form-control @error('admission_fee') is-invalid @enderror" value="{{ old('admission_fee') }}" required>
                                    @error('admission_fee')
                                ...
                                <div class="form-group col-md-6 mt-2">
                                    ...
                                    <input type="text" name="inst_1" id="inst_1" class="form-control @error('inst_1') is-invalid @enderror" value="{{ old('inst_1') }}" required>
                                    @error('inst_1')
                                    <span class="invalid-feedback form-invalid fw-bold"
                                        role="alert">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-md-6 mt-2">
                                    ...
                                    <input type="text" name="inst_2" id="inst_2" class="form-control @error('inst_2') is-invalid @enderror" value="{{ old('inst_2') }}" required>
                                    @error('inst_2')
                                    <span class="invalid-feedback form-invalid fw-bold"
                                        role="alert">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-md-6 mt-2">
                                    ...
                                    <input type="text" name="ins_discount" id="ins_discount" class="form-control @error('ins_discount') is-invalid @enderror" value="{{ old('ins_discount') }}" required>
                                    @error('ins_discount')
                                ...
                                <div class="form-group col-md-12 mt-2">
                                    ...
                                    <input type="text" name="inst_total" id="inst_total" class="form-control @error('inst_total') is-invalid @enderror" value="{{ old('inst_total') }}" readonly>
                                    @error('inst_total')
                                    <span class="invalid-feedback form-invalid fw-bold" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
...
<script>
    $(document).ready(function() {
        function calculateTotal() {
            ...
            let discount = parseFloat($('#ins_discount').val()) || 0;

            let total = admission + firstInstall + secondInstall - discount;

            $('#inst_total').val(total.toFixed(2));
        }
        $('#admission_fee, #inst_1 ,#inst_2, #ins_discount').on('input', calculateTotal);
        // calculateTotal();
    });
</script>
@endsection