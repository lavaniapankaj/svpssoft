...
class FeePrintController extends Controller
{
    ...
    //                 ->with('fee_of', $feeDetail->fee_of == 1 && $fee_id == 1 ? 'Admission Fee ' : ($feeDetail->fee_of == ($fee_id == 2 ? 1 : 2) ? 'Ist Installment Fee ' : ($feeDetail->fee_of == ($fee_id == 2 ? 2 : 3) ? 'IInd Installment Fee ' : ($feeDetail->fee_of == ($fee_id == 2 ? 3 : 4) ? 'Complete Fee ' : ''))))
